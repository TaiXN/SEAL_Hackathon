        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 bg-white p-5 rounded-[2rem] border border-slate-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)]">
          ...
          <div className="flex items-center w-full sm:w-80">
            <input
              ...
              className="w-full bg-slate-50 border border-slate-200 text-sm font-semibold text-[#f26f21] rounded-xl px-5 py-3.5 outline-none focus:bg-white focus:border-fpt-orange focus:ring-4 focus:ring-fpt-orange/10 transition-all placeholder:text-slate-400"
            />
          </div>
        </div>
              ...
              <tbody className="divide-y divide-slate-50">
                {isLoading ? (
                  <tr>
                    ...
                    >
                      <Hexagon className="w-8 h-8 animate-spin mx-auto mb-3 text-[#f26f21]" />
                      Loading Archive...
                    </td>
                  </tr>
