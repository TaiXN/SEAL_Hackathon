      ...
      <main className="max-w-6xl mx-auto mt-10 space-y-6 px-4">
        <header className="mb-8">
          ...
          <p className="text-slate-500 mt-2 text-sm font-medium">
            Manage and evaluate teams assigned to you for the Hackathon.
          </p>
        </header>
            ...
            <tbody className="divide-y divide-slate-100">
              {isLoading ? (
                ...
                <tr>
                  ...
                  >
                    Please log in again so the system can identify your Judge account.
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  >
                    You have no assigned teams yet, or no teams have submitted in your Tracks.
                  </td>
                </tr>
              ) : (
