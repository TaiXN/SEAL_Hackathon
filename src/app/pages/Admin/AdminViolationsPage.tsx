...
//     },
//     { id: "3", name: "Alpha Coders", status: "Hợp lệ", reason: "-" },
//     { id: "4", name: "ByteMe", status: "Hợp lệ", reason: "-" },
//     {
//       id: "5",
//       name: "CopyPasters",
//       status: "Đã loại",
//       reason: "Đạo văn mã nguồn",
//     },
//   ]);
...
//   // --- STATE QUẢN LÝ MODAL LOẠI ĐỘI THI ---
...
//     setViolationReason(""); // Reset lý do mỗi lần mở
//     setIsModalOpen(true);
//   };
...
//     // Cập nhật lại danh sách đội thi
//     if (selectedTeam) {
//       setTeams((prevTeams) =>
//         prevTeams.map((team) =>
...
//     // Báo thành công bằng SweetAlert2 cho mượt
//     Swal.fire({
//       icon: "success",
//       title: "Đã xử lý!",
